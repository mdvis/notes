...
- Linux Command  
    intro: |  
    [Sed](https://www.gnu.org/software/sed/manual/sed.html "https://www.gnu.org/software/sed/manual/sed.html") is a stream editor, this sed cheat sheet contains sed commands and some common sed tricks.  
    plugins:
- copyCode
...
See: [Sed examples](#sed-examples "#sed-examples")
...
See also: [File spacing](#file-spacing "#file-spacing")
...
- [sed cheatsheet](https://gist.github.com/ssstonebraker/6140154 "https://gist.github.com/ssstonebraker/6140154") _(gist.github.com)_