...
- Linux Command  
    intro: |  
    [Cron](https://en.wikipedia.org/wiki/Cron "https://en.wikipedia.org/wiki/Cron") is most suitable for scheduling repetitive tasks. Scheduling one-time tasks can be accomplished using the associated at utility.  
    plugins:
- copyCode
...
- [Devhints](https://devhints.io/cron "https://devhints.io/cron") _(devhints.io)_
- [Crontab Generator](https://crontab-generator.org/ "https://crontab-generator.org/") _(crontab-generator.org)_
- [Crontab guru](https://crontab.guru/ "https://crontab.guru/") _(crontab.guru)_